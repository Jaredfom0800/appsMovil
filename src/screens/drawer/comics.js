...
class Comics extends Component {
    ...
    async componentDidMount(){
      try {
        const response = await fetch('https://gateway.marvel.com:443/v1/public/comics?title=Deadpool&apikey=fec608dfd4a7a9acb339c68e2264d7cf');
          ...
          <Content padder contentContainerStyle = {misEstilos.content}>
            <Card>
              <CardItem header bordered style = {misEstilos.body}>
                <Text style = {misEstilos.textCenter} >Comics</Text>
              </CardItem>
